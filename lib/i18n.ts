  ...
  de: {
    ...
    buyers: {
      ...
      form: {
        ...
        carDetails: 'Fahrzeugdetails oder Inserat-Link',
        location: 'Standort des Fahrzeugs',
    ...
    mechanics: {
      ...
      form: {
        ...
        email: 'E-Mail-Adresse',
        phone: 'Telefonnummer',
        area: 'Ihr Einsatzgebiet (Stadt / Region)',
        qualifications: 'Qualifikationen (optional)',
        message: 'Weitere Informationen (optional)',
        submit: 'Registrierung absenden',
        submitting: 'Wird gesendet…',
        success: 'Vielen Dank! Wir nehmen Sie bald in unser Netzwerk auf.',
        error: 'Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut.',
      },
    },
  ...
  en: {
    ...
    buyers: {
      ...
      form: {
        ...
        carDetails: 'Car details or listing link',
    ...
    mechanics: {
      ...
      form: {
        ...
        email: 'Email address',
        phone: 'Phone number',
        area: 'Your service area (city / region)',
        qualifications: 'Qualifications (optional)',
        message: 'Additional information (optional)',
        submit: 'Submit application',
        submitting: 'Sending…',
        success: 'Thank you! We will be in touch shortly to add you to our network.',
        error: 'Something went wrong. Please try again.',
      },
    },
